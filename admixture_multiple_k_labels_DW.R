...
pdf(file=paste0(opt$outPrefix, ".pdf"), width = 7, height = 10)
    ...
    # Add sample names at top # Works but cex does not work and words too big.
    axis(3, at=bp, labels=labels$ind[order(labels$n)], las=2, tick=F, cex.axis=0.6)
